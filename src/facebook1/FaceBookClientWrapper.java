...
public class FaceBookClientWrapper {
     ...
     */
    public UseWithPicture getMe() throws IOException, PortletException {
        return this.fetchObject("me", UseWithPicture.class, Parameter.with("fields", "id,name,picture"));
    }
     ...
     */
    public static int getFriendsCount() throws IOException, PortletException {
        Connection<NamedFacebookType> myFriends = Facebook1.facebookClient.fetchConnection("me/friends", NamedFacebookType.class);
   ...
   /* public static boolean isUserLikes(String accessToken, String url) {
    ...
    public static List<User> getFriends(String access_token) {
    ...
    public List<FacebookUserBean> getFriends(final List<String> idsOfFriendsToDisplay) throws IOException, PortletException {
        ...
        if (idsOfFriendsToDisplay.size() > 0) {
            ...
            for (String id : idsOfFriendsToDisplay) {
                ...
                UseWithPicture friend = facebookClient.getJsonMapper().toJavaObject(current.toString(), UseWithPicture.class);
